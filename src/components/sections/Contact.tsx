...
const contactInfo = [
  {
    icon: <Mail size={16} />,
    label: "Email",
    value: "vishwa@example.com",
    href: "mailto:vishwa@example.com",
  },
  {
    icon: <Phone size={16} />,
    label: "Phone",
    ...
    <section id="Contact" className="relative bg-black py-32 overflow-hidden">
      ...
      <Container>
          ...
          <div className="flex flex-col justify-between gap-10">
            ...
            >
              ...
              <p className="text-[14px] text-neutral-500 leading-relaxed">
                I&apos;m actively taking on new clients and freelance projects. Whether
                you need a full-stack MVP, an API, or a complete MERN
            ...
            <div className="flex items-center gap-5">
              {[
                ...
                },
                {
                  ...
                  path: "M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.748l7.73-8.835L2.007 2.25h6.938l4.24 5.607 5.059-5.607zm-1.161 17.52h1.833L7.084 4.126H5.117z",
                  fill: true,
                },
              ].map((s) => (
                <a
        ...
        <div className="mt-24 pt-8 border-t border-white/[0.06] flex flex-col sm:flex-row items-center justify-between gap-4 text-[12px] text-white/20">
          <span>© 2024 Vishwa. All rights reserved.</span>
